...
| Option | Default | Description |
|--------|---------|-------------|
| `Config.DailyWithdrawLimit` | `$50,000` | Max daily withdrawals |
| `Config.DailyTransferLimit` | `$100,000` | Max daily transfers |
| `Config.LargeTransactionThreshold` | `$50,000` | Threshold for large transaction alerts |
| `Config.LowBalanceThreshold` | `$500` | Low balance warning level |
...
| `AllowOrgToPersonalTransfer` | `true` | Allow org → personal transfers |
| `OrgToPersonalDailyLimit` | `$100,000` | Daily org → personal limit |
